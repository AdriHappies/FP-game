...
func coger_pregunta():
	...
	pregunta.set_pregunta("Indique cuál de las siguientes no es una dirección IP correcta:")
	pregunta.set_respuestaA("255.3.4.5")
	pregunta.set_respuestaB("115.26.13.4")
	pregunta.set_respuestaC("10.0.0.1")
	pregunta.set_respuestaD("0.0.0.3")
